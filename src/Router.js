...
const ServicePattern = lazy(() => import("./views/apps/Contract/Services/ServicePattern.js"))
const SubServicePattern = lazy(() => import("./views/apps/Contract/Services/SubServicePattern.js"))
...
const contract = lazy(() => import("./views/pages/invoice/Contract"))
