        ...
        <Card style={{background:'#ffcccc'}}>
          <CardBody>
            ...
            <div style={{textAlign:'center', marginBottom:'20px',marginTop:'15px'}}>
              <div style={{display:'inline-block', color: '#ffffff',fontWeight: 'bold', paddingTop:'10px', height: '40px', width:'45%',background:'red'}}>45%</div>
              <div style={{display:'inline-block', color: '#ffffff',fontWeight: 'bold', paddingTop:'10px', height: '40px',width:'55%',background:'blue'}}>55%</div>
            </div>
            <h5>
            ...
            <div className="d-flex justify-content-start align-items-center mb-1" style={{marginLeft:'20px'}}>
            ...
            <div className="d-flex justify-content-start align-items-center mb-1" style={{marginLeft:'60px'}}>
              <CornerDownRight className="mr-50" size={25}  style={{marginLeft:'15px'}}/>
              <div className="avatar mr-50">
                <img src={person6} alt="Avatar" height="30" width="30" />
              </div>
